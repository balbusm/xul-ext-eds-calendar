...
export default [
  ...
  },
  {
    ...
    rules: {
      ...
      "@stylistic/key-spacing": [2, { beforeColon: false, afterColon: true, mode: "minimum" }],
      ...
      "@stylistic/space-before-function-paren": [2, { anonymous: "never", named: "never" }],
      ...
      "@stylistic/operator-linebreak": [2, "after", { overrides: { ":": "before", "?": "ignore" } }],
      ...
      // "@stylistic/no-extra-parens": [2, "all", { "conditionalAssign": false, "returnAssign": false, "nestedBinaryExpressions": false }],
      ...
      "@stylistic/no-multiple-empty-lines": [2, { max: 2, maxEOF: 0, maxBOF: 0 }],
